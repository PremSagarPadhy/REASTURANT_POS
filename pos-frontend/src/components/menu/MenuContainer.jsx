...
const MenuContainer = () => {
  ...
  if (loading || (!selected && categories.length > 0)) {
    return <div className="flex justify-center items-center h-full">Loading menu categories...</div>;
  }

  if (categories.length === 0) {
    return <div className="flex justify-center items-center h-full">No menu categories available.</div>;
  }
